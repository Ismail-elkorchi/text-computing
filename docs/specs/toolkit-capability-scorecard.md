...
| `@ismail-elkorchi/textcorpus` | `slice-proven` | docs/specs/textcorpus-collection-contract.md<br>fixtures/corpus-tfidf-bm25/slices.json<br>fixtures/retrieval/slices.json | Add relevance judgments, larger corpora, fielded query syntax, streaming behavior, and performance thresholds. |
