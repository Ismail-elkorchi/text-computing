...
| `nlp-conllu-dependency-readiness` | `readiness-only` | CoNLL-U/UD import-export and dependency-target annotation readiness artifacts exist; no importer, exporter, dependency parser, or broad UD treebank behavior is implemented. | CoNLL-U/UD research ledger<br>valid and invalid CoNLL-U fixtures<br>textdoc dependency-target contract<br>fixture and schema validator | No CoNLL-U importer or exporter behavior is implemented<br>No dependency parser or parser comparator capture is implemented<br>No broad UD treebank or language coverage is claimed |
