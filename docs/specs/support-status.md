...
| `nlp-pos-morph-lemma` | `slice-proven` | Deterministic POS, lemma, and morphology outputs exist only for the frozen issue #10 slices. | frozen POS/morph/lemma slices<br>expected outputs<br>package tests<br>fixtures/reports/nlp-pos-morph-lemma/conformance-report.json | Not a trained or broad multilingual tagger; fixture-bound deterministic behavior only |
...
| `nlp-conllu-dependency-roundtrip` | `slice-proven` | CoNLL-U/UD import-export round-trip behavior exists only for the frozen repository-authored fixtures; no dependency parser or broad UD treebank behavior is implemented. | CoNLL-U/UD research ledger<br>valid and invalid CoNLL-U fixtures<br>textdoc dependency-target contract<br>recorded round-trip expected outputs<br>fixtures/reports/nlp-conllu-dependency-roundtrip/conformance-report.json | No dependency parser or parser comparator capture is implemented<br>No broad UD treebank or language coverage is claimed |
