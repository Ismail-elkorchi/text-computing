...
| Relation extraction | `slice-proven` | Typed relation schemas, frozen expected outputs, deterministic corpus-slice behavior, negative controls, and conformance report | Needs executed comparator captures and larger corpus evaluation. |
| Coreference | `slice-proven` | Mention/chain schemas, frozen expected outputs, deterministic corpus-slice behavior, negative controls, and conformance report | Needs executed comparator captures and larger corpus evaluation. |
