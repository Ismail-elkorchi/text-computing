...
| 3 | Chunking and relation extraction | `textrules`, `textdoc`, `textconformance` | Relation extraction is slice-proven for a frozen repository-authored corpus slice; executed external comparator captures and larger corpus evaluation remain future gates. |
...
| 5 | Coreference | `textdoc`, `textrules`, `textconformance` | Coreference is slice-proven for a frozen repository-authored corpus slice; executed comparator captures and larger corpus evaluation remain future gates. |
