...
| 3 | Chunking and relation extraction | `textrules`, `textdoc`, `textconformance` | Relation extraction is slice-proven for frozen repository-authored short texts; executed external comparator captures and corpus evaluation remain future gates. |
...
| 5 | Coreference | `textdoc`, `textrules`, `textconformance` | Coreference is slice-proven for frozen repository-authored short texts; executed comparator captures and corpus evaluation remain future gates. |
