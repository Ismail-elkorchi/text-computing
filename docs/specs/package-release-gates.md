...
| `@ismail-elkorchi/textconformance` | `private-unreleased` | `slice-proven` | `blocked` | `proven` | Benchmark runner and release-oriented report rendering are not release-ready.<br>Package-quality publication checks have not been promoted beyond private-unreleased status. |
