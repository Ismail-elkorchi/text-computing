...
| `@ismail-elkorchi/textrules` | `beta` | External comparator captures and corpus evaluation are incomplete for several implemented task surfaces. | Blocks broader behavior claims; does not authorize new comparator matrices during alpha foundation release. |  |
