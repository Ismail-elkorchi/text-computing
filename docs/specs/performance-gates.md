...
Small fixture correctness can be mistaken for operational scale. This document keeps operational statements tied to measured gates.
...
The current manifest defines deterministic performance and scale gates. Broader operational statements require measured evidence against these gates.
...
- This file records performance gate requirements before broad operational statements.
