...
- `inputs/` contains script and language-family smoke inputs that do not claim task behavior until a task-specific expected-output and comparator gate is added.
