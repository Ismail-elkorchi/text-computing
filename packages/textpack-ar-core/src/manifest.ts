...
export const manifest: TextPackManifest = {
	...
	resources: [
		{ id: "morph-ar-root-demo", kind: "morphology", path: "resources/morph.ar.root.tsv", format: "tsv" },
		{ id: "lexicon-ar-demo", kind: "lexicon", path: "resources/lexicon.ar.demo.tsv", format: "tsv" },
		{ id: "profile-ar-core", kind: "segmentation-profile", path: "resources/profile.ar.core.txt", format: "lines" },
	],
	capabilities: { segmentation: "profile", morphology: "rules" },
	license: "MIT",
	citations: ["repo:packages/textpack-ar-core/resources"],
} as const;
