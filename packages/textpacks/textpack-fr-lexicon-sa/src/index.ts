...
export interface LoadFrenchLexiconShareAlikeOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadFrenchLexiconShareAlikeOptions,
): Promise<unknown> {
	void options;
...
export async function loadFrenchLexiconShareAlike(
	options: LoadFrenchLexiconShareAlikeOptions = {},
) {
...
export default { manifest, resources, loadFrenchLexiconShareAlike };
