...
export interface LoadEnglishSyntaxOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadEnglishSyntaxOptions,
): Promise<unknown> {
	void options;
...
export async function loadEnglishSyntax(
	options: LoadEnglishSyntaxOptions = {},
) {
...
export default { manifest, resources, loadEnglishSyntax };
