	...
	"capabilitySlots": [
		{
			...
			"bindings": [
				{
					"role": "primary",
					"resourceId": "fr-tatoeba-corpus-canonical",
					"schemaId": "textdata.corpus.v1",
					"required": true,
				...
				{
					"role": "table",
					"resourceId": "fr-tatoeba-corpus-sentences",
					"schemaId": "textdata.corpus.rows.v1",
					"required": true,
					"ownerPackage": "@ismail-elkorchi/textcorpus"
				}
		...
		},
		{
			...
			"bindings": [
				{
					"role": "evidence",
					"resourceId": "fr-tatoeba-corpus-quality",
					"schemaId": "textquality.evidence.v1",
					"required": true,
				...
				{
					"role": "quality",
					"resourceId": "fr-tatoeba-corpus-quality-profile",
					"schemaId": "textquality.profile.v1",
					"required": true,
					"ownerPackage": "@ismail-elkorchi/textquality"
				}
