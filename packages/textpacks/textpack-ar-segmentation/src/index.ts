...
export interface LoadArabicSegmentationOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadArabicSegmentationOptions,
): Promise<unknown> {
	void options;
...
export async function loadArabicSegmentation(
	options: LoadArabicSegmentationOptions = {},
) {
...
export default { manifest, resources, loadArabicSegmentation };
