...
export interface LoadFrenchMorphologyShareAlikeOptions
...
export async function loadFrenchMorphologyShareAlike(
	options: LoadFrenchMorphologyShareAlikeOptions = {},
) {
...
export default { manifest, resources, loadFrenchMorphologyShareAlike };
