...
async function resolveGeneratedComponent(
	...
	switch (component.packageName) {
		...
		case "@ismail-elkorchi/textpack-ar-syntax-sa": {
			const module = await import(component.packageName);
			const loader = module.loadArabicSyntaxShareAlike;
			if (typeof loader !== "function") {
				throw new TypeError(
					`Generated component resolver for ${component.packageName} did not export loadArabicSyntaxShareAlike.`,
				);
			}
			return loader(options);
		}
