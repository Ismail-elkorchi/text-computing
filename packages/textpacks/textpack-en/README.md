...
- `en-esdb-default-wordlists` (lexicon, textpack-indexed-table-v1)
...
- `en-esdb-default-wordlists-lookup-index` (dataset, textpack-indexed-table-v1)
- `en-scowl-inflection-entries` (morphology, textpack-indexed-table-v1)
...
- `en-scowl-inflection-entries-lookup-index` (dataset, textpack-indexed-table-v1)
- `wordnet-en-lexical-entries` (lexicon, textpack-indexed-table-v1)
...
- `wordnet-en-lexical-entries-lookup-index` (dataset, textpack-indexed-table-v1)
- `wikidata-en-entities` (knowledge-base, textpack-indexed-table-v1)
- `wikidata-en-aliases` (knowledge-base, textpack-indexed-table-v1)
- `wikidata-en-relations` (knowledge-base, textpack-indexed-table-v1)
...
- `wikidata-en-entities-lookup-index` (dataset, textpack-indexed-table-v1)
- `wikidata-en-aliases-lookup-index` (dataset, textpack-indexed-table-v1)
- `wikidata-en-relations-lookup-index` (dataset, textpack-indexed-table-v1)
