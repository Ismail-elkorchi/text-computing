...
const languageTag = "en" as const;
const languageName = "English" as const;
...
function taskReader(
	...
	throw new TypeError(
		`loadEnglish task ${taskName} requires options.reader to materialize generated file-backed resources.`,
	);
}
