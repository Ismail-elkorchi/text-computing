...
export interface LoadEnglishMorphologyOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadEnglishMorphologyOptions,
): Promise<unknown> {
	void options;
...
export async function loadEnglishMorphology(
	options: LoadEnglishMorphologyOptions = {},
) {
...
export default { manifest, resources, loadEnglishMorphology };
