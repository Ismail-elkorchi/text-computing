...
const languageName = "French" as const;
...
export interface FrenchRuntime {
	readonly languageTag: typeof languageTag;
...
function taskReader(
	...
	throw new TypeError(
		`loadFrench task ${taskName} requires options.reader to materialize generated file-backed resources.`,
	);
}
