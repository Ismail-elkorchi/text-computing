...
export const manifest: TextPackManifest = {
	...
	"resources": [
		...
		},
		{
			...
			"kind": "lexicon",
			"path": "resources/lexique-383.entries.lookup-index.v1.txt",
		...
		},
		{
			...
			"kind": "morphology",
			"path": "resources/unimorph-fra.paradigms.lookup-index.v1.txt",
			"format": "textpack-indexed-table-v1",
		...
		},
		{
			...
			"kind": "knowledge-base",
			"path": "resources/wikidata-fr.entities.lookup-index.v1.txt",
			"format": "textpack-indexed-table-v1",
			"license": "CC0-1.0",
			"citations": [
		...
		},
		{
			...
			"kind": "knowledge-base",
			"path": "resources/wikidata-fr.aliases.lookup-index.v1.txt",
			"format": "textpack-indexed-table-v1",
			"license": "CC0-1.0",
			"citations": [
				"Wikidata main structured data dump, 2026-06-08."
		...
		},
		{
			...
			"kind": "knowledge-base",
			"path": "resources/wikidata-fr.relations.lookup-index.v1.txt",
			"format": "textpack-indexed-table-v1",
			"license": "CC0-1.0",
			"citations": [
				"Wikidata main structured data dump, 2026-06-08."
	...
	"capabilitySlots": [
		...
		},
		{
			...
			"readerRequired": true,
			"notes": [
				"The bundled distribution resources provide local Wikidata French core entity rows.",
		...
		},
		{
			...
			"readerRequired": true,
			"notes": [
				"The bundled distribution resources provide generated French quality evidence and coverage reports over the selected local build units.",
		...
		},
		{
			...
			"readerRequired": true,
			"notes": [
				"The executable search profile performs Unicode word tokenization, Unicode casefolding, and lookup-only accent folding. Lexique form/lemma data remains available through the lexicon and morphology slots and is not applied automatically by the search adapter."
			],
			"capabilities": {
				"search": "analyzer"
			}
