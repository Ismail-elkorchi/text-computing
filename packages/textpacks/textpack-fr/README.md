...
- `fr-lexique-entries-lookup-index` (dataset, tsv)
- `fr-unimorph-paradigms` (morphology, tsv+gzip+base64)
- `fr-unimorph-lookup-analyzer` (morphology, tsv+gzip+base64)
- `fr-unimorph-lookup-generator` (morphology, tsv+gzip+base64)
...
- `fr-unimorph-paradigms-lookup-index` (dataset, tsv)
- `wikidata-fr-entities` (knowledge-base, text/tab-separated-values)
- `wikidata-fr-aliases` (knowledge-base, text/tab-separated-values)
- `wikidata-fr-relations` (knowledge-base, text/tab-separated-values)
