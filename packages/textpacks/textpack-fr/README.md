...
```ts
import pack, { manifest, resources } from "@ismail-elkorchi/textpack-fr";
...
- `fr-segmentation-boundary-properties` (segmentation-profile, tsv)
...
- `fr-lexique-entries` (lexicon, textpack-indexed-table-v2)
...
- `fr-lexique-entries-lookup-index` (dataset, textpack-indexed-table-v2)
- `fr-unimorph-paradigms` (morphology, textpack-indexed-table-v2)
- `fr-unimorph-feature-inventory` (morphology, tsv)
- `fr-unimorph-pos-inventory` (morphology, tsv)
- `fr-unimorph-morphology-canonical` (morphology, json)
- `fr-unimorph-quality` (quality-profile, json)
- `fr-unimorph-quality-profile` (quality-profile, json)
- `fr-unimorph-paradigms-lookup-index` (dataset, textpack-indexed-table-v2)
- `wikidata-fr-entities` (knowledge-base, textpack-indexed-table-v2)
- `wikidata-fr-aliases` (knowledge-base, textpack-indexed-table-v2)
- `wikidata-fr-relations` (knowledge-base, textpack-indexed-table-v2)
- `wikidata-fr-kb-canonical` (knowledge-base, json)
- `wikidata-fr-quality` (quality-profile, json)
- `wikidata-fr-quality-profile` (quality-profile, json)
- `wikidata-fr-entities-lookup-index` (dataset, textpack-indexed-table-v2)
- `wikidata-fr-aliases-lookup-index` (dataset, textpack-indexed-table-v2)
- `wikidata-fr-relations-lookup-index` (dataset, textpack-indexed-table-v2)
