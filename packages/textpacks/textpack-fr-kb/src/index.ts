...
export interface LoadFrenchKnowledgeBaseOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadFrenchKnowledgeBaseOptions,
): Promise<unknown> {
	void options;
	switch (component.packageName) {
		case "@ismail-elkorchi/textpack-wikidata-fr":
...
export async function loadFrenchKnowledgeBase(
	options: LoadFrenchKnowledgeBaseOptions = {},
) {
...
export default { manifest, resources, loadFrenchKnowledgeBase };
