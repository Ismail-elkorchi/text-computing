...
export interface LoadFrenchSyntaxOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadFrenchSyntaxOptions,
): Promise<unknown> {
	void options;
...
export async function loadFrenchSyntax(options: LoadFrenchSyntaxOptions = {}) {
...
export default { manifest, resources, loadFrenchSyntax };
