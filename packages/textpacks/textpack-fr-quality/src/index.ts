...
export interface LoadFrenchQualityOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadFrenchQualityOptions,
): Promise<unknown> {
	void options;
...
export async function loadFrenchQuality(
	options: LoadFrenchQualityOptions = {},
) {
...
export default { manifest, resources, loadFrenchQuality };
