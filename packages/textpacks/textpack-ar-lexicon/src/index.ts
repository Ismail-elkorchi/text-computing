...
export interface LoadArabicLexiconOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadArabicLexiconOptions,
): Promise<unknown> {
	void options;
...
export async function loadArabicLexicon(
	options: LoadArabicLexiconOptions = {},
) {
...
export default { manifest, resources, loadArabicLexicon };
