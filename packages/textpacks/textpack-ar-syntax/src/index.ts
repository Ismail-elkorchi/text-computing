...
export interface LoadArabicSyntaxOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadArabicSyntaxOptions,
): Promise<unknown> {
	void options;
...
export async function loadArabicSyntax(options: LoadArabicSyntaxOptions = {}) {
...
export default { manifest, resources, loadArabicSyntax };
