...
export interface LoadArabicKnowledgeBaseOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadArabicKnowledgeBaseOptions,
): Promise<unknown> {
	void options;
	switch (component.packageName) {
		case "@ismail-elkorchi/textpack-wordnet-ar":
			return import(component.packageName);
		case "@ismail-elkorchi/textpack-wikidata-ar":
			return import(component.packageName);
		default:
			throw new TypeError(
...
export async function loadArabicKnowledgeBase(
	options: LoadArabicKnowledgeBaseOptions = {},
) {
...
export default { manifest, resources, loadArabicKnowledgeBase };
