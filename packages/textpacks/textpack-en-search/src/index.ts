...
export interface LoadEnglishSearchOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadEnglishSearchOptions,
): Promise<unknown> {
	void options;
...
export async function loadEnglishSearch(
	options: LoadEnglishSearchOptions = {},
) {
...
export default { manifest, resources, loadEnglishSearch };
