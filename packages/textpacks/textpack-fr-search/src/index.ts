...
export interface LoadFrenchSearchOptions
...
async function resolveGeneratedComponent(
	...
	options: LoadFrenchSearchOptions,
): Promise<unknown> {
	void options;
...
export async function loadFrenchSearch(options: LoadFrenchSearchOptions = {}) {
...
export default { manifest, resources, loadFrenchSearch };
