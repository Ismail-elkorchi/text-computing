...
- deterministic query parsing, required/prohibited term operators, metadata field filters, inverted-index retrieval, BM25 ranking, snippets, explain output, and index JSON round-trips for the frozen explicit-token retrieval slice.

This package does not yet define streaming retrieval, durable index storage, relevance-judgment evaluation, broad field weighting, or corpus-level result envelopes.
