...
This package does not yet define streaming retrieval, durable index storage, external relevance benchmarks, broad field weighting, or corpus-level result envelopes.
